 ...
 * is gone.
 *
 * Every webhook signature this codebase verifies is an HMAC over the RAW bytes
...
final class RawWebhookRequest
{
     ...
     * header value configured in the RevenueCat dashboard. A handler may
     * therefore need to accept either, and a test that only exercises the HMAC
     * path has not covered the default configuration.
     */
