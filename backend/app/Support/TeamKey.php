...
/**
 * What a team's primary key can look like on THIS deployment.
 *
 ...
 *
 * Extracted because two callers had grown their own copy of it, the RevenueCat
...
{
    /**
     * Whether [$id] could be a team key at all on this deployment.
     *
     * A cheap SHAPE check and nothing more. It answers "is this worth a database
     * lookup", never "does this team exist", so a caller still has to resolve
