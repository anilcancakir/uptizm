...
<section id="signal" class="border-b border-border bg-surface-container">
    <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div class="max-w-2xl">
            @include('marketing.partials.eyebrow', ['text' => __('Signal, not noise')])
            <h2 data-reveal class="mt-3 text-section text-balance text-fg">{{ __('What it does when it') }} <span class="text-primary">{{ __('does not know') }}</span></h2>
