/// View Configuration
///
/// Customizes the appearance of Magic UI components (dialogs, confirms, loading).
/// These className values are read by MagicFeedback via Config.get('view.*').
Map<String, dynamic> get viewConfig => {
      'view': {
        'dialog': {
          'class':
              'bg-white dark:bg-gray-800 rounded-xl p-6 shadow-2xl max-w-lg',
        },
        'confirm': {
          'container_class':
          ...
          'button_cancel_class':
              'px-4 py-2 text-gray-600 dark:text-gray-300',
