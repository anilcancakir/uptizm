...
import 'preview/monitor_detail_screen.preview.dart';
import 'preview/monitors_list_screen.preview.dart';
...
List<PreviewEntry> previewEntries() {
  return <PreviewEntry>[
    ...
    PreviewEntry(
      label: 'ComponentStatusRow',
      slug: 'component_status_row',
      builder: (_) => const ComponentStatusRowPreview(),
    ),
    PreviewEntry(
    ...
    PreviewEntry(
      label: 'KeyValueEditor',
      slug: 'key_value_editor',
      builder: (_) => const KeyValueEditorPreview(),
    ),
    PreviewEntry(
      label: 'KpiStatCard',
      slug: 'kpi_stat_card',
    ...
    PreviewEntry(
      label: 'RegionPicker',
      slug: 'region_picker',
      builder: (_) => const RegionPickerPreview(),
    ),
    PreviewEntry(
      label: 'SloBudgetCard',
      slug: 'slo_budget_card',
      builder: (_) => const SloBudgetCardPreview(),
    ),
    PreviewEntry(
      label: 'StatusBadge',
      slug: 'status_badge',
