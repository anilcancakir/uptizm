// IncidentCard component — folder-local barrel.
//
...
export 'incident_card.dart' show IncidentCard;
export 'incident_card.recipe.dart'
    show kIncidentCardImpactAxis, incidentCardRecipe;
