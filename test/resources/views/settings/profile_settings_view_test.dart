...
void main() {
  group('Profile Settings Translation Keys', () {
    test('locale and timezone translation keys exist', () async {
      ...
      final profileSettings =
          translations['profile_settings'] as Map<String, dynamic>;

      expect(
        profileSettings.containsKey('select_language'),
        isTrue,
        reason: 'profile_settings.select_language key should exist',
      );
      expect(
        profileSettings.containsKey('select_timezone'),
        isTrue,
        reason: 'profile_settings.select_timezone key should exist',
      );
      expect(
        profileSettings.containsKey('language_desc'),
        isTrue,
        reason: 'profile_settings.language_desc key should exist',
      );
      expect(
        profileSettings.containsKey('timezone_desc'),
        isTrue,
  ...
  group('Profile Controller', () {
    test(
      'doUpdateProfile method exists with timezone and language parameters',
      () {
