...
import 'package:uptizm/ui/components/upgrade_dialog/index.dart';
import 'package:uptizm/ui/components/upgrade_dialog/upgrade_dialog.preview.dart';
...
void main() {
  ...
  testWidgets('preview renders every plan label without error', (tester) async {
    ...
    expect(find.byType(UpgradeDialog), findsNWidgets(3));
    expect(find.text('Available on Pro and up.'), findsOneWidget);
