...
void main() {
  ...
  testWidgets('MonitorListRow with responseMs shows formatted latency', (
    ...
    await tester.pumpWidget(wrap(const MonitorListRow(monitor: monitor)));
  ...
  testWidgets('MonitorListRow onTap fires when tapped', (tester) async {
    ...
    await tester.pumpWidget(
      wrap(MonitorListRow(monitor: monitors.first, onTap: () => tapped = true)),
    );
  ...
  testWidgets(
    ...
    (tester) async {
      final degraded = monitors.firstWhere(
  ...
  testWidgets('MonitorListRow renders down StatusBadge for down monitor', (
    ...
    final down = monitors.firstWhere((m) => m.status == StatusKey.down);
  ...
  testWidgets('MonitorListRow renders paused StatusBadge for paused monitor', (
    ...
    final paused = monitors.firstWhere((m) => m.status == StatusKey.paused);
