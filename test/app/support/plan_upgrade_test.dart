...
import 'package:uptizm/app/support/plan_upgrade.dart';
...
void main() {
  MagicResponse gated({
    ...
    return MagicResponse(
      data: <String, dynamic>{'message': message, 'upgrade': ?upgrade},
      statusCode: status,
    );
  }
  ...
  group('PlanUpgradeRequirement display + routing', () {
    ...
    test('carries the billing intent that starts the upgrade on arrival', () {
      expect(PlanUpgradeRequirement.billingPath, equals('/teams/billing'));
